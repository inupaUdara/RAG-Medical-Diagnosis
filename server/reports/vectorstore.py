...
PINECONE_INDEX_NAME = os.getenv("PINECONE_INDEX_NAME", "medical-diagnosis")
...
async def load_vectorstore(uploaded_files: List[UploadFile], uploaded: str, doc_id: str):
    """ 
    Save files, chunks texts, create embeddings, and upsert to Pinecone. and write metadata to MongoDB.
    """
